========================================================================
    KONSOLENANWENDUNG: SchaltJahrEingabe-Projektübersicht
========================================================================

Diese SchaltJahrEingabe-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre SchaltJahrEingabe-Anwendung besteht.


SchaltJahrEingabe.vcxproj
...
SchaltJahrEingabe.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen SchaltJahrEingabe.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
